...
exports.run = async (client, message, args) => {
  ...
  .format(" D [gün], H [saat], m [dakika], s [saniye]");
    ...
    .addFields({ name: 'Bot Sahibi', value: `Rexty`, inline: false})
    ...
    .addFields({ name: '• Bot Kuruluş', value: `24.08.2022`, inline: true})
    .addFields({ name: '• Komut Sayısı', value: `99`, inline: true})

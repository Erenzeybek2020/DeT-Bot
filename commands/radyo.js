...
const connection = joinVoiceChannel({
   ...
   selfDeaf: false
    ...
    message.reply("EfkarFM Çalıyor 🎧")
        ...
        > **Radyo Kanalları: \`alem, cnnturk, fenomen, kral, kralpop, line, joyfm, fenomenturk, show, taksimclup, eksen, açık, süperfm, slowturk, efkar\` yada kanaldan ayrılmam için \`r!radyo bitir\` yaz.**`)
    }
}

...
module.exports.run = async(client, message, args, tools) => {
  ...
  if(!kanal) return message.reply({content: "Bir Rol Etiketlemeli veya Rolün Adını yazmalısın. Örnek `r!otorol #kanal @rol`", allowedMentions: { repliedUser: false }})
  if(!rol) return message.reply({content: "Bir Rol Etiketlemeli veya Rolün Adını yazmalısın. Örnek `r!otorol #kanal @rol`", allowedMentions: { repliedUser: false }})
